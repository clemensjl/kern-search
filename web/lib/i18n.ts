...
const S = {
  de: {
    ...
    footer: "Kern Search – Preise umgerechnet zum Tageskurs, ohne Gewähr. Links öffnen extern.",
    ...
    ob_title: "Willkommen bei Kern Search", ob_sub: "Kurz einrichten – alles später oben in der Leiste änderbar.",
  ...
  en: {
    ...
    footer: "Kern Search – prices converted at daily rates, no guarantee. Links open externally.",
    ...
    ob_title: "Welcome to Kern Search", ob_sub: "Quick setup – everything can be changed later in the top bar.",
