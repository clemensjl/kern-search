...
// Bewusst kurze Liste: nur Agenten, denen Clemens vertraut und bei denen eine
// eigene Provisionskennung hinterlegt ist (siehe lib/affiliate.ts). Die frueheren
// 21 Eintraege stehen in der Git-Historie, falls einer zurueckkommen soll.
